                ...
                <div className={classes.body} >
                    ...
                    <div id='homeText' >
                        ...
                        <Typography style={{ border:'2px solid black' , backgroundColor:'black' , color : 'white' , width:'85%' , margin:'0 auto' , padding:'80px' , marginTop:'60px'}} >
                            ...
                            <img style={{  width:'50%', height:'50%', paddingRight:'20px', float:'right', paddingBottom:'10px' , paddingTop:'10px'}} src='https://tse2.mm.bing.net/th?id=OIP.qreriz7qMmj7tHnqjGQoAAHaEK&pid=Api&P=0&w=303&h=171' alt='img' />
                        </Typography>
                        <Typography>
