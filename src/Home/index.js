            ...
            <body >
                <div className={classes.body} >
                    ...
                    <div id='homeText' >
                        ...
                        <Typography >
                               <img style={{ width:'35%', height:'35%', paddingRight:'20px', float:'left', paddingBottom:'10px'}} src='https://tse2.mm.bing.net/th?id=OIP.Cnwy5E1c99f4VsFTCs4_nwHaE1&pid=Api&P=0&w=263&h=173' alt='img' />
                        ...
                        <Typography style={{ border:'2px solid black' , backgroundColor:'black' , color : 'white' , width:'85%'  , padding:'30px' , marginTop:'60px'}} className='blackBox'>
                            ...
                            <img style={{  width:'50%', height:'50%', paddingRight:'20px', float:'right', paddingBottom:'10px' , paddingTop:'0px'}} src='https://tse2.mm.bing.net/th?id=OIP.qreriz7qMmj7tHnqjGQoAAHaEK&pid=Api&P=0&w=303&h=171' alt='img' />
                        </Typography>
                        <Typography>
